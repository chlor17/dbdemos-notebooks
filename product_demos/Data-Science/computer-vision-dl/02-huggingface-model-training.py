...
# MAGIC %pip install databricks-sdk==0.39.0 datasets==2.20.0 transformers==4.49.0 tf-keras==2.17.0 accelerate==1.4.0 mlflow==3.1.0 torchvision==0.20.1 deepspeed==0.14.4 evaluate==0.4.3
